...
public class Registrasi extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.r1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.example.exercise1.Registrasi.AnonymousClass1 */
        ...
        this.r2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.example.exercise1.Registrasi.AnonymousClass2 */
        ...
        this.r3
            ...
            /* class com.example.exercise1.Registrasi.AnonymousClass3 */
        ...
        this.gendergp.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.example.exercise1.Registrasi.AnonymousClass4 */
        ...
        this.reg.setOnClickListener(new View.OnClickListener() {
            /* class com.example.exercise1.Registrasi.AnonymousClass5 */
        ...
        this.cancel.setOnClickListener(new View.OnClickListener() {
            /* class com.example.exercise1.Registrasi.AnonymousClass6 */
    ...
    public void validasi(View view) {
        if (this.regnama.getText().toString().isEmpty() || this.regalamat.getText().toString().isEmpty() || this.regemail.getText().toString().isEmpty() || this.regpass.getText().toString().isEmpty() || this.regrepass.getText().toString().isEmpty() || this.agama.isEmpty() || this.jk.isEmpty()) {
            Toast.makeText(getApplicationContext(), "Data Must Be Filled", 0).show();
        }
        if (this.regnama.getText().toString().isEmpty()) {
            this.wrongnameerr.setError("Name Cannot Be Empty");
            this.cnama = false;
        } else {
        ...
        if (this.regalamat.getText().toString().isEmpty()) {
            this.wrongalamat.setError("Address Cannot Be Empty");
            this.calamat = false;
        } else {
        ...
        if (this.regemail.getText().toString().isEmpty()) {
            this.wrongmailerror.setError("Email Cannot Be Empty");
            this.cmail = false;
        ...
        if (this.regpass.getText().toString().isEmpty()) {
            this.wongpasserror.setError("Password Cannot Be Empty");
            this.cpass = false;
        } else if (this.regpass.getText().length() < 6) {
            this.wongpasserror.setError("Password Minimum 6 Character");
            this.cpass = false;
        } else {
            this.cpass = true;
        ...
        if (this.regrepass.getText().toString().isEmpty()) {
            this.wongrepasserror.setError("Re-Password Cannot Be Empty");
            this.crpass = false;
        } else if (this.regrepass.getText().length() < 6) {
            this.wongrepasserror.setError("Re-Password Minimum 6 Character");
            this.crpass = false;
        } else if (!this.regrepass.getText().toString().equals(this.regpass.getText().toString())) {
            this.wongrepasserror.setError("Password Are Not The Same");
            this.crpass = false;
        } else {
            this.crpass = true;
        ...
        if (this.cnama && this.calamat && this.cmail && this.cpass && this.crpass && !this.agama.isEmpty() && !this.jk.isEmpty()) {
            Toast.makeText(getApplicationContext(), "Registration Succes", 1).show();
